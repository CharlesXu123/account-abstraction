...
//     console.log(
//       `\tPaymaster balance: ${paymasterBalance} (${ethers.utils.formatEther(
//         paymasterBalance
//       )} eth)`
//     );
...
//       await paymaster
//         .connect(deployer)
//         .addStake(21600, { value: ethers.utils.parseEther("0.1") })
//     ).wait();
...
//         .withdrawTo(
//           deployer.address,
//           await entrypoint.balanceOf(paymasterAddress)
//         )
//     ).wait();
//   });
// });
